          ...
          >
            ...
            <View style={styles.distanceBox}>
              ...
              >
                ...
                >
                  오늘의 거리{" "}
                  <Text style={{ fontSize: 15 }}>{10 * todayCoin}</Text>
              ...
              <View style={{ width: "100%", height: 7, marginTop: 17 }}>
                ...
                />
                <View
                  style={[styles.moveDistance, { width: `${distance}%` }]}
                />
              </View>
            </View>
            ...
            <View style={styles.pointBox}>
              ...
              <TouchableOpacity
                ...
                onPress={() => setGowithdraw(!gowithdraw)}
              >
                <Text
                  style={{ color: "white", fontSize: 14, fontWeight: "600" }}
                >
            ...
            <TouchableOpacity
              activeOpacity={0.8}
              style={[styles.footer, { marginBottom: 16 }]}
            >
              <View
                style={{
                  flexDirection: "row",
              ...
              >
                ...
                <Text
                  style={{ color: "#8B94A8", fontSize: 10, fontWeight: "500" }}
                >
                  적립금을 내 계좌로 출금하세요.
                </Text>
              </View>
