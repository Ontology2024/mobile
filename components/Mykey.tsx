...
export default function Mykey({ setGoToKey, coin }) {
  return (
    <View style={styles.container}>
      <Image source={coinkeyBg} style={styles.bg} />
      <View style={styles.header}>
        <TouchableOpacity onPress={() => setGoToKey(false)} activeOpacity={0.8}>
      ...
      <ScrollView style={{ width: "100%" }} contentContainerStyle={{ alignItems: "center" }} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.pointBox}>
          <View style={{ flexDirection: "row", width: "100%", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <View>
              <Text style={{ color: "white", fontSize: 20, fontWeight: "600" }}>{point}원</Text>
            </View>
          </View>
          <TouchableOpacity activeOpacity={0.8} style={styles.withdrawBtn}>
